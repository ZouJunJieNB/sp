...
const routes = [{
    ...
    children: [
        ...
        },
        {
            ...
            component: () =>
                import(
                    "@/components/client/projectManagement/projectImplementation/fat"
                ),
        },
        {
            // 客户: 我的项目
        ...
        },
        {
            ...
            children: [{
                ...
                component: () =>
                    import(
                        "@/components/client/projectManagement/budget/personnelPreparation/trainingPlan"
                    ),
            },],
        },
        {
            ...
            name: "businessTerms",
            component: () =>
                import("@/components/client/projectManagement/budget/businessTerms"),
        },
        {
            // 客户: 资金准备
            path: "/fundPreparation",
            name: "fundPreparation",
            component: () =>
                import("@/components/client/projectManagement/budget/fundPreparation"),
        },
        /** ------------SP-------------- */
        {
            // SP: 商品管理
